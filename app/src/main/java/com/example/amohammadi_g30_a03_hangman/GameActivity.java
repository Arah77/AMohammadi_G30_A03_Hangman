...
public class GameActivity extends AppCompatActivity implements View.OnClickListener, Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtWelPlayer.setText("Welcome " + playerName);
    ...
    protected void initialize(Scanner scan) {
        game.populateWordList(scan);
    ...
    // Method is to populate the scoreboard
